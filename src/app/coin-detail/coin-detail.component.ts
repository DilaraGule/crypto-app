...
export class CoinDetailComponent implements OnInit {
    ...
    datasets: [
      {
        ...
        borderColor: '#1C542D',
        pointBackgroundColor: '#1C542D',
        pointBorderColor: '#1C542D',
        pointHoverBackgroundColor: '#1C542D',
        pointHoverBorderColor: '#1C542D',
      }
    ],
    labels: []
  };
  ...
  ngOnInit(): void {
    ...
    this.currencyService.getCurrency().subscribe(val => {
      this.currency = val;
      this.getGraphData(this.days);
      //verilerin doğru gelip gelmediği kontrol ediliyor.
      this.getCoinData();
    });
  }
